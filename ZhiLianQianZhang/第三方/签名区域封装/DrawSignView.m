...
#define RGBCOLORX(r,g,b) [UIColor colorWithRed:(r)/255.0f green:(g)/255.0f blue:(b)/255.0f alpha:0]
...
- (void)createView
{
    ...
    contentLbl.frame = CGRectMake(0, 50, 200, 50);
...
#pragma mark - 清空button  frame
    clearBtn.frame = CGRectMake(77, 275, 90, 30);
    ...
    okBtn.frame = CGRectMake(399, 280, 90, 21);
    ...
    for (UIButton *btn in btnRArr) {
        btn.frame = CGRectMake(300, btn_y+ i * (btn_h+btn_mid), btn_w, btn_h);
        i++;
    }
...
//    sliderLbl.frame = CGRectMake(100, 300, 100, 20);
//    sliderLbl.font = [UIFont systemFontOfSize:15.0];
...
//    [sliderLbl release];
    ...
    penBoldSlider.frame = CGRectMake(200+10, 300, 200, 20);
    ...
    self.drawView=[[MyView alloc]initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 255)];
