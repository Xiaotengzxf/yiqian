...
//@property (nonatomic, strong) UIImageView *image_View_image;
@end
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        NSUserDefaults *User_Def_B = [NSUserDefaults standardUserDefaults];
        
        NSString *str_Bifang = [User_Def_B objectForKey:@"bf"];
        
        NSInteger Int_Bifing_H = [str_Bifang integerValue];
        
        NSLog(@"%li",Int_Bifing_H);
        
        [self.beizerPath setLineWidth:Int_Bifing_H];
    }
    return self;
}
...
- (void)drawRect:(CGRect)rect{
    //设置签名的颜色
    UIColor *strokeColor = self.Color_with_Next;
